      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          <AspectRatio
            ...
            ratio={896 / 1831}
            className={
              "pointer-events-none relative z-50 aspect-[896/1831] w-full"
            }
          >
            <NextImage
              fill
      ...
      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
        <ScrollArea className={"relative flex-1 overflow-auto"}>
          <div
            aria-hidden={"true"}
            className={
              "absolute bg-gradient-to-t from-white pointer-events-none h-12"
            }
          />
            ...
            <div className="relative mt-4 h-full flex flex-col justify-between">
              <div className="flex flex-col gap-6">
                  ...
                  <div className="mt-3 flex items-center space-x-3">
                    {COLORS.map((color) => (
                      <Radio
                        ...
                        className={({ checked }) =>
                          cn(
                            "relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-/5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none border-2 border-r-transparent",
                ...
                <div className="relative  flex flex-col gap-3 w-full">
                  <Label className={"capitalize"}>{MODELS.name}</Label>
                  <DropdownMenu>
